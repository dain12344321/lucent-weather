(function () {
  ...
  function update(s, preview) {
    ...
    const phase = preview?.moonPhase ?? illum.phase;
    const fraction =
      preview?.moonPhase === undefined
        ? illum.fraction
    ...
    document.body.dataset.moonUp = String(
      preview?.moonPhase !== undefined || pos.altitude > 0,
    );
  }
  const api = { phaseName, draw, update };
